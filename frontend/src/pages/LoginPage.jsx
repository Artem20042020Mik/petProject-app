...
function LoginPage() {
    ...
    const handleSubmit = async (e) =>
    {
        ...
        try{
            ...
            setError(e.response?.data?.error || "error by logging in")
        }
    } ;
        ...
        <div className="min-h-[100vh] bg-gray-100 flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center">
                <div className="bg-white shadow-xl p-10 rounded-2xl w-full max-w-md ">
                    <h1 className="text-2xl text-gray-500 mb-4 font-bold">log in</h1>
                    {error && (
                    ...
                    <p className="text-sm font-light mt-2 text-left ml-2 text-gray-500">no account?{" "}
                    <Link to="/register" className="text-indigo-600 hover:underline font-bold">register</Link></p>
